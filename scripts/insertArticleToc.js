...
function insertArticleToc() {
  ...
  if (firstH2Title && EMAD_LOPPO.article_toc && h2TitleNumber.length >= 2) {
    var toc_div = document.createElement('div');
    toc_div.setAttribute('class', 'article-toc');
    toc_div.innerHTML = '<h3>目录 [<span class="toc-controller toc-controller-show"><a>隐藏</a></span>]</h3>' + EMAD_LOPPO.article_toc;
